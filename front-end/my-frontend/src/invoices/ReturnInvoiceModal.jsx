...
//       msg.innerHTML = `
//         <div>
//           <p class="font-bold text-lg">✅ Invoice Returned Successfully!</p>
//           <p class="text-sm mt-1">Invoice: ${invoice.invoiceNumber}</p>
//           <p class="text-sm">Amount: Rs.${invoice.paidAmount.toFixed(2)}</p>
//           <p class="text-sm font-semibold mt-2">📦 Stock has been restored</p>
//           <p class="text-sm">💰 Expense record created</p>
//         </div>
//       `;
...
//                 onClick={onClose}
//                 disabled={loading}
//                 className="px-6 py-2 border-2 border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors font-medium disabled:opacity-50"
//               >
//                 Cancel
//               </button>
//               <button
...
//                 className="px-6 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white font-bold rounded-md transition-colors flex items-center space-x-2 disabled:cursor-not-allowed"
//               >
//                 {loading ? (
//                   <>
