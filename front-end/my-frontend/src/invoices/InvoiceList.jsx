...
// // Replace the getUserRole function with this - it checks the 'sub' field
...
//     // Check the 'sub' field - it contains the username
//     const username = payload.sub;
//     console.log('👤 Username (sub):', username);
    
//     // If username is 'admin', they are admin
