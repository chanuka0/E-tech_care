...
// const CancelOrderModal = ({ jobCardId, onSuccess, onClose }) => {
...
//       const response = await apiCall(`/api/jobcards/${jobCardId}/cancel`, {
//         method: 'POST',
...
//       successMsg.textContent = 'Job card cancelled successfully!';
...
//         <h3 className="text-xl font-bold text-gray-900 mb-4">Cancel Job Card</h3>
...
//                 ⚠️ Customer cancellation requires a fee
//               </p>
//             </div>
//           )}
...
//               type="submit"
//               disabled={loading}
//               className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white font-medium rounded-md transition-colors"
//             >
