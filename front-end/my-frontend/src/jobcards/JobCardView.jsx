...
<style>
    ...
    /* SIGNATURE SECTION - UPDATED TO MATCH YOUR IMAGE */
    .sig-section {
        border: 2px solid #4a5568;
        padding: 8px;
        display: grid;
...
<!-- CUSTOMER & DEVICE IN TWO COLUMNS -->
<div class="row-2">
    <div class="card">
...
<div class="card serial">
    <div class="card-h">DEVICE SERIAL</div>
    <div class="card-b">
        <div class="serial-num">${deviceSerial.serialValue}</div>
    </div>
</div>
` : ''}
...
<!-- CONDITION & FAULTS IN TWO COLUMNS -->
<div class="row-2">
...
<div class="card">
    ...
    <div class="card-b">
        <div class="payment">
            ...
            <div class="payment-amt">Rs. ${jobCard.advancePayment?.toFixed(2) || '0.00'}</div>
        </div>
    </div>
</div>
