...
//         [name]: type === 'checkbox' ? checked : (type === 'number' ? parseFloat(value) || 0 : value)
//       };
//       // ✅ When serialization is enabled, force quantity to 0 (serials manage qty)
...
//                 )}
//               </label>
//               {/* ✅ Disabled + grayed out when serialization is enabled */}
//               <input
//                 type="number"
//                 name="quantity"
//                 value={formData.hasSerialization ? 0 : formData.quantity}
//                 onChange={handleChange}
//                 onWheel={(e) => e.target.blur()}
//                 min="0"
