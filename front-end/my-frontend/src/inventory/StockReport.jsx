...
//       const [summaryData, movementsData, itemReportData, trendsData, mostUsedData, categoryData] = await Promise.all([
...
//     const matchesItem = !selectedItem || movement.inventoryItem?.id === selectedItem;
...
//     const headers = ['Date', 'Time', 'Item Name', 'SKU', 'Type', 'Quantity', 'Reference', 'Serial Number', 'Performed By', 'Previous Qty', 'New Qty', 'Notes'];
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-900">📊 Stock In/Out Report</h1>
//           <p className="text-gray-600 mt-1">Track inventory movements and trends</p>
//         </div>
...
//               disabled={loading}
//               className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors font-medium disabled:bg-gray-400"
//             >
...
//                       <td className="px-6 py-4 text-sm text-center text-gray-600">{item.category}</td>
