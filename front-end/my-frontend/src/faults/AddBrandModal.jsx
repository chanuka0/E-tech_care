...
const AddBrandModal = ({ onAdd, onClose, existingBrands = [] }) => {
  const [formData, setFormData] = useState({
    brandName: '',
    description: '',
    isActive: true
  ...
  useEffect(() => {
    // Create a Set of existing brand names for quick lookup
    const names = existingBrands.map(brand => brand.brandName.toLowerCase().trim());
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="flex justify-between items-center mt-1">
              <p className="text-xs text-gray-500">
                Must be unique. 2-255 characters.
              </p>
          ...
          <div className="flex space-x-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors font-medium flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
