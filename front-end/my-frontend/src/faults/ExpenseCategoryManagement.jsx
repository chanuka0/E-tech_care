...
//         <div>
//           <h3 className="text-2xl font-bold text-gray-900">Expense Categories</h3>
//           <p className="text-gray-600 mt-1">Create and manage expense categories for your team</p>
//         </div>
//         <button
//           onClick={() => setShowAddModal(true)}
//           className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center space-x-2"
...
//               </svg>
//               <h3 className="text-lg font-medium text-gray-900">No Categories Found</h3>
//               <p className="text-gray-600 mt-1">{searchTerm ? 'Try adjusting your search' : 'Create your first expense category'}</p>
//             </div>
//           </div>
//         ) : (
//           <div className="overflow-x-auto">
