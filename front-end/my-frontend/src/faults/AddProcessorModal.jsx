...
// const AddProcessorModal = ({ onAdd, onClose }) => {
...
//           <h3 className="text-xl font-bold">Add New Processor</h3>
//           <button 
//             onClick={onClose} 
...
//               placeholder="e.g., Intel Core i5-1135G7, AMD Ryzen 5"
...
const AddProcessorModal = ({ onAdd, onClose, existingProcessors = [] }) => {
  const [formData, setFormData] = useState({
    processorName: '',
    description: '',
    isActive: true
  ...
  const checkDuplicate = (name) => {
    ...
    return existingProcessors.some(
      processor => processor.processorName.toLowerCase() === trimmedName
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Validation 3: Duplicate check (client-side)
