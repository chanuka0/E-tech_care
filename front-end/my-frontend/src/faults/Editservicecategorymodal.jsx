...
//               required
//             />
//             <p className="text-xs text-gray-500 mt-1">Category ID: #{category.id}</p>
//           </div>
...
//               <strong>Created:</strong> {new Date(category.createdAt).toLocaleDateString('en-US', {
//                 year: 'numeric',
//                 month: 'short',
//                 day: 'numeric',
//                 hour: '2-digit',
...
//           <div>
//             <label className="block text-sm font-medium text-gray-700 mb-2">
//               Service Price (Rs.) <span className="text-red-500">*</span>
//             </label>
//             <div className="relative">
//               <span className="absolute left-3 top-2 text-gray-500 font-medium">Rs.</span>
//               <input
//                 type="number"
//                 name="servicePrice"
...
//               />
//             </div>
//             <p className="text-xs text-gray-500 mt-1">Price charged for this service</p>
//           </div>
...
//               ⚠️ Marking as inactive will prevent it from appearing in job card service dropdowns
//             </div>
//           )}

//           <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
//             <p className="text-xs text-blue-700 space-y-1">
//               <p><strong>Created:</strong> {new Date(category.createdAt).toLocaleDateString('en-US', {
//                 year: 'numeric',
//                 month: 'short',
//                 day: 'numeric',
//                 hour: '2-digit',
//                 minute: '2-digit'
//               })}</p>
//               <p><strong>Last Updated:</strong> {new Date(category.updatedAt).toLocaleDateString('en-US', {
//                 year: 'numeric',
//                 month: 'short',
//                 day: 'numeric',
//                 hour: '2-digit',
