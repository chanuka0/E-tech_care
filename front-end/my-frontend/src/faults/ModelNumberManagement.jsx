...
//   const handleDeleteModelNumber = async (id) => {
//     const modelNumberToDelete = modelNumbers.find(mn => mn.id === id);
//     const confirmMessage = `Are you sure you want to permanently delete model number "${modelNumberToDelete?.modelNumber}"?\n\nThis action cannot be undone and the record will be removed from the database.`;
...
//         });
//         setModelNumbers(modelNumbers.filter(mn => mn.id !== id));
//         showSuccessMessage('Model number permanently deleted from database!');
//       } catch (err) {
//         const errorMsg = err.message || 'Failed to delete model number';
//         setError(errorMsg);
//         showErrorMessage(errorMsg);
//       }
//     }
