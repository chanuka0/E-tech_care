...
//           <p className="text-gray-600 mt-1">Manage service types available for job cards</p>
//         </div>
//         <button
...
//   const totalServiceRevenue = categories
//     .filter(c => c.isActive)
//     .reduce((sum, c) => sum + (c.servicePrice || 0), 0);
...
//         <div>
//           <h2 className="text-3xl font-bold text-gray-900">Service Categories</h2>
//           <p className="text-gray-600 mt-1">Manage service types and pricing available for job cards</p>
//         </div>
//         <button
//           onClick={() => setShowAddModal(true)}
//           className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center space-x-2"
...
//                         Rs. {category.servicePrice ? category.servicePrice.toFixed(2) : '0.00'}
//                       </span>
//                     </td>
//                     <td className="px-6 py-4 whitespace-nowrap">
//                       <span className={`px-3 py-1 rounded-full text-xs font-medium ${
...
//               <p className="text-3xl font-bold text-purple-600">Rs. {totalServiceRevenue.toFixed(2)}</p>
//             </div>
