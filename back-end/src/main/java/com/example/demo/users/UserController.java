...
//    }
//
//    // UPDATED: Get current user's profile from JWT token
//    @GetMapping("/profile")
//    @PreAuthorize("isAuthenticated()")
...
//    }
//
//    // OPTIONAL: Keep the old endpoint with parameter for admin use
...
//    }
//
//    // Public user registration (self-registration)
//    @PostMapping("/register")
//    public ResponseEntity<?> registerUser(@RequestBody User user) {
//        try {
//            User registeredUser = userService.registerUser(user);
...
//    }
//
//    // First admin registration (comment @PreAuthorize for first admin only)
//    @PostMapping("/register/admin")
...
//    }
//
//    // Admin manually creates a new ADMIN
...
//    }
//
//    // Get all users and admins (Admin only)
...
//    }
//
//    // Get only users with ROLE_USER (Admin only)
...
//    }
//
//    // Get only admins with ROLE_ADMIN (Admin only)
