...
//    }
//
//    // IMPORTANT: GET by ID with EAGER loading of items
//    @GetMapping("/{id}")
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
//    public ResponseEntity<Invoice> getInvoiceById(@PathVariable Long id) {
...
//    }
//
//    @GetMapping("/search/jobcard")
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
//    public ResponseEntity<List<Invoice>> searchByJobCard(@RequestParam String jobCardNumber) {
//        return ResponseEntity.ok(invoiceService.searchByJobCardNumber(jobCardNumber));
//    }
//
//    @GetMapping("/search/customer")
...
//        Long cancelledBy = getUserIdFromToken();
//
//        return ResponseEntity.ok(invoiceService.cancelInvoice(id, reason, cancelledBy));
//    }
//
//    @GetMapping("/jobcard/{jobCardId}")
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
//    public ResponseEntity<Invoice> getInvoiceByJobCard(@PathVariable Long jobCardId) {
//        return ResponseEntity.ok(invoiceService.findByJobCardId(jobCardId));
//    }
//
//    @DeleteMapping("/{id}")
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
