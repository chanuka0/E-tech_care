...
//
//    /**
//     * Remove a service category from an existing job card
//     */
...
public class JobCardController {
    ...
    // FIXED: Device Condition Endpoints - now support multiple
