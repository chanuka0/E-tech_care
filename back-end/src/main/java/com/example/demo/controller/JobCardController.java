...
//                    "lastJobNumber", stats.lastJobNumber,
//                    "nextJobNumber", stats.nextJobNumber,
//                    "date", LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")),
//                    "statusBreakdown", Map.of(
//                            "pending", stats.pending,
//                            "inProgress", stats.inProgress,
//                            "waitingForParts", stats.waitingForParts,
//                            "waitingForApproval", stats.waitingForApproval,
...
//            return ResponseEntity.ok(Map.of(
//                    "date", LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")),
//                    "count", todayNumbers.size(),
//                    "jobNumbers", todayNumbers,
//                    "nextNumber", jobCardService.getNextJobNumberPreview()
//            ));
//        } catch (RuntimeException e) {
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
//                    .body(new ErrorResponse(e.getMessage()));
//        }
//    }
//    // ✅ ADD THIS TO JobCardController.java
//
//    /**
//     * ✅ NEW: Get active regular customers for dropdown in job card creation
//     */
//    @GetMapping("/customers/active")
//    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
//    public ResponseEntity<List<?>> getActiveCustomers() {
//        try {
//            // Call customer service to get active customers (similar to existing Customer Management)
//            // This will return a list of customers that can be selected
//            List<?> customers = apiCall(API_BASE_URL + "/api/customers/active");
...
//
//    /**
//     * ✅ NEW: Get customer summary/statistics
//     */
...
//            summary.put("totalServiceCount", customer.getTotalServiceCount());
//            summary.put("creditBalance", customer.getCreditBalance());
//            summary.put("totalJobCards", jobCards.size());
//
//            // Count by status
//            Map<String, Long> statusCounts = jobCards.stream()
//                    .collect(Collectors.groupingBy(
//                            jc -> jc.getStatus().toString(),
//                            Collectors.counting()
//                    ));
...
//
//            return ResponseEntity.ok(Map.of(
//                    "testJobNumber", testNumber,
//                    "exists", exists,
//                    "date", today,
//                    "sequence", String.format("%06d", sequence)
//            ));
//        } catch (RuntimeException e) {
