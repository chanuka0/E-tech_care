...
public class ReportController {
     ...
     */
    @GetMapping("/income-expenses/monthly")
    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
    public ResponseEntity<ReportService.IncomeExpenseReport> getMonthlyIncomeExpenseReport(
        ...
        return ResponseEntity.ok(reportService.getMonthlyIncomeExpenseReport(year, month));
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
    public ResponseEntity<ReportService.DailyDetailsReport> getDailyDetails(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
        return ResponseEntity.ok(reportService.getDailyDetails(date));
    }
