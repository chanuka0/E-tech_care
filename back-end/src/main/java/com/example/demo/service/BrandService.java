...
public class BrandService {
    ...
    private Map<String, Object> createBrandPayload(Brand brand) {
        Map<String, Object> payload = new HashMap<>();
        payload.put("id", brand.getId());
        payload.put("brandName", brand.getBrandName());
        payload.put("description", brand.getDescription());
        payload.put("isActive", brand.getIsActive());
        payload.put("createdAt", brand.getCreatedAt());
        payload.put("updatedAt", brand.getUpdatedAt());
        return payload;
    }
