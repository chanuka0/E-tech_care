...
public class ModelNumberService {
    ...
    @Transactional
    public ModelNumber activateModelNumber(Long id) {
        ModelNumber modelNumber = getModelNumberById(id);

        if (modelNumber.getIsActive()) {
            throw new RuntimeException("Model number is already active");
        }
    ...
    @Transactional
    public ModelNumber deactivateModelNumber(Long id) {
        ModelNumber modelNumber = getModelNumberById(id);

        if (!modelNumber.getIsActive()) {
            throw new RuntimeException("Model number is already inactive");
        }
